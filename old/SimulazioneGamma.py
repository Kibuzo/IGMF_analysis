...
#sim.add(PropagationBP(MagneticField=Bfield)) #Bfield tol
...
# sim.add(SynchrotronRadiation(Bfield))
sim.add(EMInverseComptonScattering(URB_Protheroe96,True))


# Ho messo un po' tutti i moduli tanto la simulazione runna veloce, manca il campo magnetico al momento
# That was before. Tolti i seguenti:
...
sim.add(obs)
sim.run(source,50,True) #quel numero sono il numero di gamma sparati
